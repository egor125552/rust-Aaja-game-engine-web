...
export class CoreBridge {
  ...
  static async load(): Promise<CoreBridge> {
    ...
    try {
      // This module is generated by wasm-pack and copied into dist/wasm after
      // TypeScript compilation. Keep the import literal so Vite and similar
      // bundlers can discover both the generated loader and its .wasm asset.
      // @ts-ignore Generated module is verified by the build and package smoke tests.
      module = (await import("./wasm/audio_game_core.js")) as WasmModule;
    } catch (error) {
      throw new Error(
