...
- Added Rust, WASM-boundary, TypeScript, package-layout, and Chromium/Firefox/WebKit CI checks plus manual iPhone/VoiceOver instructions.
- Hardened closed-context recovery, streaming-constructor cleanup, runtime input normalization, room impulse caching, and repeated voice-limit eviction.
